class Svg {
	...
	createPolygone(fill, stroke, points)
	{
		let str = "";
		for(let i=0; i < points.length; i++) {
				let x = (points[i].x + this.center_x).toString();
				let y = (points[i].y + this.center_y).toString();
				str += x + "," + y + " ";
		}
		...
		p.setAttribute("stroke-width", "2.5px");
		p.setAttribute("points", str);
